            ...
            {photos.map((photo) => (
              ...
              >
                ...
                >
                  <PhotoThumbnail
                    photoId={photo.id}
                    alt={`Foto del ${formatDateSafe(photo.date, 'es-ES')}`}
                    style={{
                      width: '100%',
                      height: '100%',
                      objectFit: 'cover',
                  ...
                  <div style={{ padding: '1rem' }}>
                    <div style={{ marginBottom: '0.5rem', fontWeight: 'bold' }}>
                      {formatDateSafe(photo.date, 'es-ES')}
                    </div>
        ...
        {selectedPhoto && (
          ...
          >
            ...
            >
              ...
              <PhotoViewer photoId={selectedPhoto.id} alt={`Foto del ${formatDateSafe(selectedPhoto.date, 'es-ES')}`} />
              <div
                style={{
                  marginTop: '1rem',
                  color: 'white',
              ...
              >
                <div style={{ fontWeight: 'bold', marginBottom: '0.5rem' }}>
                  {parseDateSafe(selectedPhoto.date).toLocaleDateString('es-ES', {
                    weekday: 'long',
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric'
